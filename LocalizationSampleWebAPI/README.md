This is a sample ASP.Net Core Web API project to demonstrate how to use localization in Web API by using resource file structure in a way single culture resource file per controller.
